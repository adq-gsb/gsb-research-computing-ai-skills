...
3. **Running LLM jobs on Stanford infrastructure: why?**
    ...
    - Local LLM vs. Stanford AI API Gateway vs. third-party API: when and why? (see [`engine-room.md`](engine-room.md))
