...
| [The Stanford AI Playground](stanford-ai-playground/) | 🖊️💬 Concept + demo | Stanford's AI offerings — the AI Playground chat window vs the API gateway, and their data-risk limits |
...
| [Boss Gate 2](boss-gate-2/) | 🔑 Capstone | The Genre Tribunal: scale a research judgment call with LLM-as-a-judge, then route the contested cases to a human |
