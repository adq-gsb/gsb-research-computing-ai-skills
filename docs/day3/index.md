...
| [Writing a Slurm Job with Claude](slurm-with-claude/) | 💻🤖 Hands-on (Claude-assisted) | **Reusable skills** — have Claude write a **project** skill (this repo's setup) and a **global** skill (Yen conventions), then generate, compare, and run a batch job with each — project vs. global scope |
